...
/* ── Flag images (embedded base64 PNGs, 32×22 source shown at 16×11 for 2× HiDPI)
   Soft famfamfam-style palette + a 1px light frame, to match the original look
   (GoSquared flat flags, MIT-licensed, downscaled). */

function mavo_flag_img( string $code, string $label ): string {
	$flags = [
		'fr' => 'data:image/png;base64,',
		'en' => 'data:image/png;base64,',
		'de' => 'data:image/png;base64,',
	];
	$src = $flags[ $code ] ?? '';
	if ( ! $src ) return '';
	return sprintf(
