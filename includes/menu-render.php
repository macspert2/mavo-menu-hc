...
function mavo_flag_img( string $code, string $label ): string {
	$flags = [
		'fr' => 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAWBAMAAABTd4N3AAAAIVBMVEX////+/Pz8/P1Wb43eYW8EKVYAJlTPFCnOESbLAhgAGEmKk8IhAAAAIUlEQVR42mNMY2Bg+HLtwwMGRubJHxkYGJgY0MCoAPUFAAu4BbRqoWYtAAAAAElFTkSuQmCC',
		'en' => 'data:image/png;base64,',
		'de' => 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAWBAMAAABTd4N3AAAAJFBMVEX/2gD/zgD/ywDoRQDdAwDrAADdAADbAADaAACTAAADAAAAAAB9A22JAAAANElEQVR42mPczYAKmBgoF2B5jy4giC5wD11gD7qAMSEtmNbeI2QGI7oABmBUQhcQpEEAAQCiBQYUo8p96wAAAABJRU5ErkJggg==',
	];
	$src = $flags[ $code ] ?? '';
	if ( ! $src ) return '';
	return sprintf(
